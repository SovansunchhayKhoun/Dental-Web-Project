...
Route::get('/admin/doctor-list/{user}/password',[AdminController::class,'passwordView']);
Route::put('/admin/doctor-list/{user}/password/set', [AdminController::class,'updatePassword']);
...
// Route::delete('/admin/mailbox/{appointment}',[AdminController::class,'destroyAppointment']);

// Route::delete('/admin/doctor-list/{user}',[AdminController::class,'destroyUser']);

// Route::patch('/admin/mailbox/{appointment}',[AdminController::class,'update']);
