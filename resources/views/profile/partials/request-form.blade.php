...
<form class="p-3 flex flex-col gap-2" action="" method="post">
	@csrf
	<input style="background-color: #C0F3F7" class="border-none rounded-md" type="text" name="fName" id=""
				 required placeholder="First name">
	<input style="background-color: #C0F3F7" class="border-none rounded-md" type="text" name="lName" id=""
				 required placeholder="Last name">
	<input style="background-color: #C0F3F7" class="border-none rounded-md" type="text" name="phoneNum"
				 id="" required placeholder="Phone No.">
	<input style="background-color: #C0F3F7" class="border-none rounded-md" type="text" name="email" id=""
	...
	<textarea style="background-color: #C0F3F7" class="border-none rounded-md px-3 py-2" name="message" id=""
