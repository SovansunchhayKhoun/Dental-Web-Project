...
@section('content')
	...
	<div class="h-50 w-full mt-20 mb-10" style="background: #E5FDFF">
		<h2 class="py-5 text-center font-medium text-5xl" style="color: #55A0A7"> Smile Line Dental Clinic</h2>
		<div class="flex justify-center px-5 max-sm:flex-wrap">
			<div class="p-5 ">
				<h2 class="self-center text-center text-2xl font-semibold italic underline ">Technology</h2>
				<h2 class="py-5 text-center text-xl ">Lorem ipsum dolor sit amet, consectetuer
					adipiscing elit. Aenean commodo ligula eget dolor.
					Aenean massa. </h2>
			</div>
			<div class="p-5 ">
				<h2 class="self-center text-center text-2xl font-semibold italic underline ">Quality</h2>
				<h2 class="py-5 text-center text-xl ">Lorem ipsum dolor sit amet, consectetuer
					adipiscing elit. Aenean commodo ligula eget dolor.
					Aenean massa. </h2>
			</div>
			<div class="p-5 ">
				<h2 class="self-center text-center text-2xl font-semibold italic underline ">Customer Care</h2>
				<h2 class="py-5 text-center text-xl ">Lorem ipsum dolor sit amet, consectetuer
					adipiscing elit. Aenean commodo ligula eget dolor.
					Aenean massa. </h2>
			</div>
	...
	<div class="full flex justify-between ">
		<div class="flex items-center ml-10 mr-10 w-1/2">
			<div class="flex-1 text-black p-2 rounded-2xl relative hover:animate-bounce " style="background: #65C7D0">
				<h2 class="text-center text-3xl pb-5 underline m-5"> Implant</h2>
				<h2 class="pb-10 text-center text-xl ">Lorem ipsum dolor sit amet, consectetuer
					adipiscing elit. Aenean commodo ligula eget dolor.
					Aenean massa. </h2>
				<!-- arrow -->
		...
		<div class="w-1/2 ml-10 mr-10 p-2 hover:animate-pulse ">
			<img src="{{ asset ('assets/image/image1.png') }}" class="rounded-2xl" alt="avarta"/>
		</div>
	</div>
	{{--    small1--}}
	<div class="small flex-wrap">
		<div class="flex items-center m-10 ">
			<div class="flex-1 text-black p-2 rounded-2xl mb-2 relative hover:animate-bounce" style="background: #65C7D0;">
				<h2 class="text-center text-3xl pb-5 underline "> Implant</h2>
				<h2 class="pb-10 text-center text-xl">Lorem ipsum dolor sit amet, consectetuer
					adipiscing elit. Aenean commodo ligula eget dolor.
					Aenean massa. </h2>
				<!-- arrow -->
	...
	<div class="full flex justify-between ">
		<div class="w-1/2 m-10 p-2 hover:animate-pulse ">
			<img src="{{ asset ('assets/image/image2.png') }}" class="rounded-2xl" alt="avarta"/>
		</div>
	...
	<div class="full flex justify-between ">
		<div class="flex items-center ml-10 mr-10 w-1/2 mb-10 ">
			...
			<div class="m-12">
				<span class="mb-6 text-2xl font-semibold whitespace-nowrap dark:text-black flex">Dr. Chhay</span>
				<h2 class="flex text-xl">Lorem ipsum dolor sit amet, consectetuer
					adipiscing elit. Aenean commodo ligula eget dolor.
					Aenean massa. </h2>
			</div>
		</div>
		<div class="flex items-center ml-10 mr-10 w-1/2 mb-10 ">
			<img src="{{ asset ('assets/image/1.jpg') }}" class="h-40 w-40 mr-6 rounded-full" alt="avarta"/>
			<div class="m-12">
				<span class="mb-6 text-2xl font-semibold whitespace-nowrap dark:text-black flex">Dr. Pong</span>
				<h2 class="flex text-xl">Lorem ipsum dolor sit amet, consectetuer
					adipiscing elit. Aenean commodo ligula eget dolor.
					Aenean massa. </h2>
			</div>
	...
	<div id="default-carousel" class="relative w-full mb-10 " data-carousel="slide">
		...
		<div class="relative overflow-hidden rounded-lg h-96">
			...
			<div class="hidden duration-700 ease-in-out" data-carousel-item style="background: #51B1BA">
				<h2 class="py-7 text-center font-medium text-4xl text-white"> Client Testimonials</h2>
				<div class="flex justify-center px-5 max-sm:flex-wrap">
